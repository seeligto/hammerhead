...
//! Micro-benchmarks for [`hammerhead_engine_core::eval`].
//!
...
use hammerhead_engine_core::coords::ORIGIN;
use hammerhead_engine_core::eval::{bench_layer1_window_scan, bench_layer2_shapes, bench_layer3_fork_bonus};
